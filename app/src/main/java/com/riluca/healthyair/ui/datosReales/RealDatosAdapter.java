...
public class RealDatosAdapter extends RecyclerView.Adapter<RealDatosAdapter.DatoVH> {
    ...
    public class DatoVH extends RecyclerView.ViewHolder {
        ...
        public void bindDato(DatoHorario datoH){
            ...
            String estacion = (estaciones.containsKey(codEstac))? estaciones.get(codEstac): codEstac;
            ...
            String magnitud = (magnitudes.containsKey(codMagnit))? magnitudes.get(codMagnit): codMagnit;
            tvMagnitud.setText(magnitud);
